...
class HistoriaClinicaC 
{
	...
	public function EditarHistoriaClinicaC(){
		...
		if (isset($resultado_hc["id"]) == false) {
			...
			<div class="alert alert-warning" role="alert">
			  El paciente no tiene una historia de usuario!
			</div>
		...
		echo'
					...
					<h2>DATOS PERSONALES</h2>
						<div class="row">
							...
							Establecimineto
							<br>
							<input class="input-sm" type="text" style="width: 100%"  id="hc-establecimiento" name="hc-establecimiento" value="'.$resultado_hc["establecimiento"].'">
							</div>

							<div class="col-2">
							Nombre
							<br>
							<input class="input-sm" type="text" name="hc-nombre" id="hc-nombre" disabled readonly value="'.$resultado_paciente["nombre"].'">
							</div>

							<div class="col-2">
							Apellido
							<br>
							<input class="input-sm" type="text" name="hc-apellido" id="hc-apellido" disabled readonly value="'.$resultado_paciente["apellido"].'">
							</div>

							<div class="col-1">
							Sexo
							<br>
							<input class="input-sm" style="width: 40px" type="text" maxlength="1" onkeyup="this.value = this.value.toUpperCase();" name="hc-sexo" value="'.$resultado_hc["sexo"].'">
							...
							Edad
							<br>
							<input class="input-sm" style="width: 80px" type="number" onkeypress="return isNumber(event)" min="0" name="hc-edad" value="'.$resultado_hc["edad"].'">
							</div>

							<div class="col-2">
							<strong> N° HISTORIA CLÍNICA </strong>
							<br>
							<input class="input-sm" style="width: 50%" onkeypress="return isNumber(event)" type="number" name="hc-numero" value="'.$resultado_hc["numero"].'">
							</div>
	...
	<input class="hidden" value="" onkeypress="return isNumber(event)" id="EE1" name="EE1" style="width: 30px"> 
	<input class="hidden" value="" onkeypress="return isNumber(event)" id="EE2" name="EE2" style="width: 30px"> 
	<input class="hidden" value="" onkeypress="return isNumber(event)" id="EE3" name="EE3" style="width: 30px"> 
	<input class="hidden" value="" onkeypress="return isNumber(event)" id="EE4" name="EE4" style="width: 30px"> 
	<input class="hidden" value="" onkeypress="return isNumber(event)" id="EE5" name="EE5" style="width: 30px"> 
	<input class="hidden" value="" onkeypress="return isNumber(event)" id="EE6" name="EE6" style="width: 30px"> 
	<input class="hidden" value="" onkeypress="return isNumber(event)" id="EE7" name="EE7" style="width: 30px"> 
	<input class="hidden" value="" onkeypress="return isNumber(event)" id="EE8" name="EE8" style="width: 30px"> 
	...
	echo '
					...
					<div class="container">
						...
						<h2 class="margenSubTitulo">EDAD ESTIMADA</h2>
	...
	<!-- 1 MOTIVO CONSULTA -->
					<div class="container">
						...
						<div class="row margenSubTitulo">
							...
							<div class="col-5 "> <h2>1 MOTIVO CONSULTA</h2> </div>
							<div class="col-7 alert alert-secondary" style="font-size: 11px"> ANOTAR LA CAUSA DEL PROBLEMA EN LA VERSIÓN DEL INFORMANTE </div>
						...
						<div class="row">
							...
							<div class="col-md-12">
								...
								<textarea class="input-sm" name="hc-motivoConsulta" rows="5" cols="100" placeholder="Motivo de la consulta" >'.$resultado_hc["motivo_consulta"].'</textarea>
	...
	<!-- 2 ENFERMEDAD O PROBLEMA ACTUAL -->
					<div class="container margenSubTitulo">
						<div class="row">
							<div class="col-5"> <h2>2 ENFERMEDAD O PROBLEMA ACTUAL</h2> </div>
							<div class="col-7 alert alert-secondary" style="font-size: 11px"> REGISTRAR SÍNTOMAS: CRONOLOGÍA, LOCALIZACIÓN, CARACTERÍSTICAS, INTENSIDAD, CAUSA APARENTE, SÍNTOMAS ASOCIADOS, EVOLUCIÓN, ESTADO ACTUAL. </div>
						</div>
						...
						<div class="row">
							...
							<div class="col-md-12">
								...
								<textarea class="input-sm" name="hc-enfermedad_problema_actual" rows="5" cols="100" placeholder="Enfermedad o problema actual">'.$resultado_hc["enfermedad_problema_actual"].'</textarea>
	...
	<input class="hidden" onkeypress="return isNumber(event)" id="EPA1" name="EPA1" value="">
	<input class="hidden" onkeypress="return isNumber(event)" id="EPA2" name="EPA2" value="">
	<input class="hidden" onkeypress="return isNumber(event)" id="EPA3" name="EPA3" value="">
	<input class="hidden" onkeypress="return isNumber(event)" id="EPA4" name="EPA4" value="">
	<input class="hidden" onkeypress="return isNumber(event)" id="EPA5" name="EPA5" value="">
	<input class="hidden" onkeypress="return isNumber(event)" id="EPA6" name="EPA6" value="">
	<input class="hidden" onkeypress="return isNumber(event)" id="EPA7" name="EPA7" value="">
	<input class="hidden" onkeypress="return isNumber(event)" id="EPA8" name="EPA8" value="">
	<input class="hidden" onkeypress="return isNumber(event)" id="EPA9" name="EPA9" value="">
	<input class="hidden" onkeypress="return isNumber(event)" id="EPA10" name="EPA10" value="">
	...
	echo'
					...
					<div class="container">
						<h2>3 ANTECEDENTES PERSONALES Y FAMILIARES </h2>
						...
						<div class="row">
							...
							<div class="col-md-12">						 
								...
								<textarea class="input-sm" name="hc-epa-descripcion" rows="5" cols="100" placeholder="Especificaciones">'.$resultado_hc["especificaciones_antecedentes"].'</textarea>
	...
	<!-- 4 SIGNOS VITALES -->		
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-8">
					...
					<div class="container">
						...
						<div class="row" style="margin-bottom: 20px">
							...
							<div class="col-1">PRESIÓN<br>ARTERIAL</div>
							
							<div class="col-3">
							<input class="input-sm" style="width: 40%" id="presion_arterial" type="text" name="presion_arterial" value="'.$resultado_hc["presion_arterial"].'"></div>
							


							<div class="col-1">FRECUENCIA<br>CARDIACA min.</div>
							
							<div class="col-3">
							<input class="input-sm" style="width: 40%" id="frecuencia_cardiaca" type="text" name="frecuencia_cardiaca" value="'.$resultado_hc["frecuencia_cardiaca"].'"></div>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-1">TEMPERATURA °C</div>
							
							<div class="col-3">
							<input class="input-sm" style="width: 40%" id="temperatura" type="text" name="temperatura" value="'.$resultado_hc["temperatura"].'"></div>
							


							<div class="col-1">F. RESPIRAT.<br>min.</div>
							
							<div class="col-3">
							<input class="input-sm" style="width: 40%" id="f_respiratoria" type="text" name="f_respiratoria" value="'.$resultado_hc["f_respiratoria"].'"></div>
				...
				<div class="col-4"> OBSERVACIONES:<br>
					
					<textarea class="input-sm" name="observaciones_signos_vitales" rows="6" cols="42" id="observaciones_signos_vitales" placeholder="Observaciones">'.$resultado_hc["observaciones_signos_vitales"].'</textarea> 
...
<input class="hidden" onkeypress="return isNumber(event) "id="ESE1" name="ESE1">
<input class="hidden" onkeypress="return isNumber(event) "id="ESE2" name="ESE2">
<input class="hidden" onkeypress="return isNumber(event) "id="ESE3" name="ESE3">
<input class="hidden" onkeypress="return isNumber(event) "id="ESE4" name="ESE4">
<input class="hidden" onkeypress="return isNumber(event) "id="ESE5" name="ESE5">
<input class="hidden" onkeypress="return isNumber(event) "id="ESE6" name="ESE6">
<input class="hidden" onkeypress="return isNumber(event) "id="ESE7" name="ESE7">
<input class="hidden" onkeypress="return isNumber(event) "id="ESE8" name="ESE8">
<input class="hidden" onkeypress="return isNumber(event) "id="ESE9" name="ESE9">
<input class="hidden" onkeypress="return isNumber(event) "id="ESE10" name="ESE10">
<input class="hidden" onkeypress="return isNumber(event) "id="ESE11" name="ESE11">
<input class="hidden" onkeypress="return isNumber(event) "id="ESE12" name="ESE12">
	...
	echo'
					...
					<div class="container">
						...
						<div class="row margenSubTitulo">
							<div class="col-5 "> <h2>5 EXAMEN DEL SISTEMA ESTOMATOGNÁTICO </h2> </div>
							<div class="col-7 alert alert-secondary" style="font-size: 11px"> DESCRIBIR ABAJO LA PATOLOGÍA DE LA REGIÓN AFECTADA ANOTANDO EL NUMERO </div>
						</div>
						...
						<div class="row">
							...
							<div class="col-md-12">
								...
								<textarea class="input-sm" name="especificaciones_estomatognatico" rows="5" cols="100" placeholder="Especificaciones">'.$resultado_hc["especificaciones_estomatognatico"].'</textarea>
	...
	<!--6  ODONTOGRAMA -->
					<div class="container">
						...
						<div class="row margenSubTitulo">
							<div class="col-5 "> <h2>6 ODONTOGRAMA</h2> </div>
							<div class="col-7 alert alert-secondary" style="font-size: 11px"> "PINTAR CON: AZUL PARA  TRATAMIENTO REALIZADO  -   ROJO PARA PATOLOGÍA ACTUAL MOVILIDAD Y RECESIÓN: MARCAR ""X"" (1, 2 ó 3), SI APLICA" </div>
						</div>
							...
							<div class="col col-md-11">
								<div class="row">
									...
									<div class="col-5">
										...
										<input type="text" class="input-sm" style="width: 45px" onkeypress="return isNumber(event)" name="recesion_1_01" value="'.$resultado_hc["recesion_1_01"].'">
										<input type="text" class="input-sm" style="width: 45px" onkeypress="return isNumber(event)" name="recesion_1_02" value="'.$resultado_hc["recesion_1_02"].'">
										<input type="text" class="input-sm" style="width: 45px" onkeypress="return isNumber(event)" name="recesion_1_03" value="'.$resultado_hc["recesion_1_03"].'">
										<input type="text" class="input-sm" style="width: 45px" onkeypress="return isNumber(event)" name="recesion_1_04" value="'.$resultado_hc["recesion_1_04"].'">
										<input type="text" class="input-sm" style="width: 45px" onkeypress="return isNumber(event)" name="recesion_1_05" value="'.$resultado_hc["recesion_1_05"].'">
										<input type="text" class="input-sm" style="width: 45px" onkeypress="return isNumber(event)" name="recesion_1_06" value="'.$resultado_hc["recesion_1_06"].'">
										<input type="text" class="input-sm" style="width: 45px" onkeypress="return isNumber(event)" name="recesion_1_07" value="'.$resultado_hc["recesion_1_07"].'">
										<input type="text" class="input-sm" style="width: 45px" onkeypress="return isNumber(event)" name="recesion_1_08" value="'.$resultado_hc["recesion_1_08"].'">
									...
									<div class="col-5">
										...
										<input type="text" class="input-sm" style="width: 45px" onkeypress="return isNumber(event)" name="recesion_1_09" value="'.$resultado_hc["recesion_1_09"].'">
										<input type="text" class="input-sm" style="width: 45px" onkeypress="return isNumber(event)" name="recesion_1_10" value="'.$resultado_hc["recesion_1_10"].'">
										<input type="text" class="input-sm" style="width: 45px" onkeypress="return isNumber(event)" name="recesion_1_11" value="'.$resultado_hc["recesion_1_11"].'">
										<input type="text" class="input-sm" style="width: 45px" onkeypress="return isNumber(event)" name="recesion_1_12" value="'.$resultado_hc["recesion_1_12"].'">
										<input type="text" class="input-sm" style="width: 45px" onkeypress="return isNumber(event)" name="recesion_1_13" value="'.$resultado_hc["recesion_1_13"].'">
										<input type="text" class="input-sm" style="width: 45px" onkeypress="return isNumber(event)" name="recesion_1_14" value="'.$resultado_hc["recesion_1_14"].'">
										<input type="text" class="input-sm" style="width: 45px" onkeypress="return isNumber(event)" name="recesion_1_15" value="'.$resultado_hc["recesion_1_15"].'">
										<input type="text" class="input-sm" style="width: 45px" onkeypress="return isNumber(event)" name="recesion_1_16" value="'.$resultado_hc["recesion_1_16"].'">
							...
							<div class="col col-md-11">
								<div class="row">
									...
									<div class="col-5">
										...
										<input type="text" class="input-sm" style="width: 45px" onkeypress="return isNumber(event)" name="movilidad_1_01" value="'.$resultado_hc["movilidad_1_01"].'">
										<input type="text" class="input-sm" style="width: 45px" onkeypress="return isNumber(event)" name="movilidad_1_02" value="'.$resultado_hc["movilidad_1_02"].'">
										<input type="text" class="input-sm" style="width: 45px" onkeypress="return isNumber(event)" name="movilidad_1_03" value="'.$resultado_hc["movilidad_1_03"].'">
										<input type="text" class="input-sm" style="width: 45px" onkeypress="return isNumber(event)" name="movilidad_1_04" value="'.$resultado_hc["movilidad_1_04"].'">
										<input type="text" class="input-sm" style="width: 45px" onkeypress="return isNumber(event)" name="movilidad_1_05" value="'.$resultado_hc["movilidad_1_05"].'">
										<input type="text" class="input-sm" style="width: 45px" onkeypress="return isNumber(event)" name="movilidad_1_06" value="'.$resultado_hc["movilidad_1_06"].'">
										<input type="text" class="input-sm" style="width: 45px" onkeypress="return isNumber(event)" name="movilidad_1_07" value="'.$resultado_hc["movilidad_1_07"].'">
										<input type="text" class="input-sm" style="width: 45px" onkeypress="return isNumber(event)" name="movilidad_1_08" value="'.$resultado_hc["movilidad_1_08"].'">
									...
									<div class="col-5">
										...
										<input type="text" class="input-sm" style="width: 45px" onkeypress="return isNumber(event)" name="movilidad_1_09" value="'.$resultado_hc["movilidad_1_09"].'">
										<input type="text" class="input-sm" style="width: 45px" onkeypress="return isNumber(event)" name="movilidad_1_10" value="'.$resultado_hc["movilidad_1_10"].'">
										<input type="text" class="input-sm" style="width: 45px" onkeypress="return isNumber(event)" name="movilidad_1_11" value="'.$resultado_hc["movilidad_1_11"].'">
										<input type="text" class="input-sm" style="width: 45px" onkeypress="return isNumber(event)" name="movilidad_1_12" value="'.$resultado_hc["movilidad_1_12"].'">
										<input type="text" class="input-sm" style="width: 45px" onkeypress="return isNumber(event)" name="movilidad_1_13" value="'.$resultado_hc["movilidad_1_13"].'">
										<input type="text" class="input-sm" style="width: 45px" onkeypress="return isNumber(event)" name="movilidad_1_14" value="'.$resultado_hc["movilidad_1_14"].'">
										<input type="text" class="input-sm" style="width: 45px" onkeypress="return isNumber(event)" name="movilidad_1_15" value="'.$resultado_hc["movilidad_1_15"].'">
										<input type="text" class="input-sm" style="width: 45px" onkeypress="return isNumber(event)" name="movilidad_1_16" value="'.$resultado_hc["movilidad_1_16"].'">
						...
						<div class="row margenSubTitulo" >
							...
							<div class="col col-md-11">
								<div class="row">
									...
									<div class="col-md-12">
										<div class="row">
											<div class="col-1 cent-texto">18</div>
											<div class="col-1 cent-texto">17</div>
											<div class="col-1 cent-texto">16</div>
											<div class="col-1 cent-texto">15</div>
											<div class="col-1 cent-texto">14</div>
											<div class="col-1 cent-texto">13</div>
											<div class="col-1 cent-texto">12</div>
											<div class="col-1 cent-texto">11</div>
										</div>
						...
						<div class="row" >
							...
							<div class="col col-md-11 ">
								<div class="row ">
									...
									<div class="col-md-12">
										<div class="row">
											<div class="col-1 cent-texto">21</div>
											<div class="col-1 cent-texto">22</div>
											<div class="col-1 cent-texto">23</div>
											<div class="col-1 cent-texto">24</div>
											<div class="col-1 cent-texto">25</div>
											<div class="col-1 cent-texto">26</div>
											<div class="col-1 cent-texto">27</div>
											<div class="col-1 cent-texto">28</div>
										</div>
						...
						<div class="row">
							...
							<div class="col col-md-11">
								...
								<div class="row">
									...
									<div class="col-md-6">
										<div class="row">
											<div class="col-2" style="display: flex; justify-content: center; align-items: center;">55</div>
											<div class="col-2" style="display: flex; justify-content: center; align-items: center;">54</div>
											<div class="col-2" style="display: flex; justify-content: center; align-items: center;">53</div>
											<div class="col-2" style="display: flex; justify-content: center; align-items: center;">52</div>
											<div class="col-2" style="display: flex; justify-content: center; align-items: center;">51</div>
										</div>
									</div>

									<div class="col-md-6">
										<div class="row">
											<div class="col-2" style="display: flex; justify-content: center; align-items: center;">61</div>
											<div class="col-2" style="display: flex; justify-content: center; align-items: center;">62</div>
											<div class="col-2" style="display: flex; justify-content: center; align-items: center;">63</div>
											<div class="col-2" style="display: flex; justify-content: center; align-items: center;">64</div>
											<div class="col-2" style="display: flex; justify-content: center; align-items: center;">65</div>
										</div> 
									</div>
								</div>
						...
						<div class="row">
							...
							<div class="col col-md-11">
								...
								<div class="row">
									...
									<div class="col-md-6">
										<div class="row">
											<div class="col-2" style="display: flex; justify-content: center; align-items: center;">85</div>
											<div class="col-2" style="display: flex; justify-content: center; align-items: center;">84</div>
											<div class="col-2" style="display: flex; justify-content: center; align-items: center;">83</div>
											<div class="col-2" style="display: flex; justify-content: center; align-items: center;">82</div>
											<div class="col-2" style="display: flex; justify-content: center; align-items: center;">81</div>
										</div>
									</div>

									<div class="col-md-6">
										<div class="row">
											<div class="col-2" style="display: flex; justify-content: center; align-items: center;">71</div>
											<div class="col-2" style="display: flex; justify-content: center; align-items: center;">72</div>
											<div class="col-2" style="display: flex; justify-content: center; align-items: center;">73</div>
											<div class="col-2" style="display: flex; justify-content: center; align-items: center;">74</div>
											<div class="col-2" style="display: flex; justify-content: center; align-items: center;">75</div>
										</div> 
									</div>
								</div>
								...
								<div class="row ">
									...
									<div class="col-md-12">
										<div class="row">
											...
											<div class="col-1 cent-texto">48</div>
											<div class="col-1 cent-texto">47</div>
											<div class="col-1 cent-texto">46</div>
											<div class="col-1 cent-texto">45</div>
											<div class="col-1 cent-texto">44</div>
											<div class="col-1 cent-texto">43</div>
											<div class="col-1 cent-texto">42</div>
											<div class="col-1 cent-texto">41</div>
						...
						<div class="row" >
							...
							<div class="col col-md-11 ">
								<div class="row ">
									...
									<div class="col-md-12">
										<div class="row">
											<div class="col-1 cent-texto">31</div>
											<div class="col-1 cent-texto">32</div>
											<div class="col-1 cent-texto">33</div>
											<div class="col-1 cent-texto">34</div>
											<div class="col-1 cent-texto">35</div>
											<div class="col-1 cent-texto">36</div>
											<div class="col-1 cent-texto">37</div>
											<div class="col-1 cent-texto">38</div>
										</div>
							...
							<div class="col col-md-11">
								<div class="row">
									...
									<div class="col-5">
										...
										<input type="text" class="input-sm" style="width: 45px" onkeypress="return isNumber(event)" name="recesion_2_01" value="'.$resultado_hc["recesion_2_01"].'">
										<input type="text" class="input-sm" style="width: 45px" onkeypress="return isNumber(event)" name="recesion_2_02" value="'.$resultado_hc["recesion_2_02"].'">
										<input type="text" class="input-sm" style="width: 45px" onkeypress="return isNumber(event)" name="recesion_2_03" value="'.$resultado_hc["recesion_2_03"].'">
										<input type="text" class="input-sm" style="width: 45px" onkeypress="return isNumber(event)" name="recesion_2_04" value="'.$resultado_hc["recesion_2_04"].'">
										<input type="text" class="input-sm" style="width: 45px" onkeypress="return isNumber(event)" name="recesion_2_05" value="'.$resultado_hc["recesion_2_05"].'">
										<input type="text" class="input-sm" style="width: 45px" onkeypress="return isNumber(event)" name="recesion_2_06" value="'.$resultado_hc["recesion_2_06"].'">
										<input type="text" class="input-sm" style="width: 45px" onkeypress="return isNumber(event)" name="recesion_2_07" value="'.$resultado_hc["recesion_2_07"].'">
										<input type="text" class="input-sm" style="width: 45px" onkeypress="return isNumber(event)" name="recesion_2_08" value="'.$resultado_hc["recesion_2_08"].'">
									...
									<div class="col-5">
										...
										<input type="text" class="input-sm" style="width: 45px" onkeypress="return isNumber(event)" name="recesion_2_09" value="'.$resultado_hc["recesion_2_09"].'">
										<input type="text" class="input-sm" style="width: 45px" onkeypress="return isNumber(event)" name="recesion_2_10" value="'.$resultado_hc["recesion_2_10"].'">
										<input type="text" class="input-sm" style="width: 45px" onkeypress="return isNumber(event)" name="recesion_2_11" value="'.$resultado_hc["recesion_2_11"].'">
										<input type="text" class="input-sm" style="width: 45px" onkeypress="return isNumber(event)" name="recesion_2_12" value="'.$resultado_hc["recesion_2_12"].'">
										<input type="text" class="input-sm" style="width: 45px" onkeypress="return isNumber(event)" name="recesion_2_13" value="'.$resultado_hc["recesion_2_13"].'">
										<input type="text" class="input-sm" style="width: 45px" onkeypress="return isNumber(event)" name="recesion_2_14" value="'.$resultado_hc["recesion_2_14"].'">
										<input type="text" class="input-sm" style="width: 45px" onkeypress="return isNumber(event)" name="recesion_2_15" value="'.$resultado_hc["recesion_2_15"].'">
										<input type="text" class="input-sm" style="width: 45px" onkeypress="return isNumber(event)" name="recesion_2_16" value="'.$resultado_hc["recesion_2_16"].'">
							...
							<div class="col col-md-11">
								<div class="row">
									...
									<div class="col-5">
										...
										<input type="text" class="input-sm" style="width: 45px" onkeypress="return isNumber(event)" name="movilidad_2_01" value="'.$resultado_hc["movilidad_2_01"].'">
										<input type="text" class="input-sm" style="width: 45px" onkeypress="return isNumber(event)" name="movilidad_2_02" value="'.$resultado_hc["movilidad_2_02"].'">
										<input type="text" class="input-sm" style="width: 45px" onkeypress="return isNumber(event)" name="movilidad_2_03" value="'.$resultado_hc["movilidad_2_03"].'">
										<input type="text" class="input-sm" style="width: 45px" onkeypress="return isNumber(event)" name="movilidad_2_04" value="'.$resultado_hc["movilidad_2_04"].'">
										<input type="text" class="input-sm" style="width: 45px" onkeypress="return isNumber(event)" name="movilidad_2_05" value="'.$resultado_hc["movilidad_2_05"].'">
										<input type="text" class="input-sm" style="width: 45px" onkeypress="return isNumber(event)" name="movilidad_2_06" value="'.$resultado_hc["movilidad_2_06"].'">
										<input type="text" class="input-sm" style="width: 45px" onkeypress="return isNumber(event)" name="movilidad_2_07" value="'.$resultado_hc["movilidad_2_07"].'">
										<input type="text" class="input-sm" style="width: 45px" onkeypress="return isNumber(event)" name="movilidad_2_08" value="'.$resultado_hc["movilidad_2_08"].'">
									...
									<div class="col-5">
										...
										<input type="text" class="input-sm" style="width: 45px" onkeypress="return isNumber(event)" name="movilidad_2_09" value="'.$resultado_hc["movilidad_2_09"].'">
										<input type="text" class="input-sm" style="width: 45px" onkeypress="return isNumber(event)" name="movilidad_2_10" value="'.$resultado_hc["movilidad_2_10"].'">
										<input type="text" class="input-sm" style="width: 45px" onkeypress="return isNumber(event)" name="movilidad_2_11" value="'.$resultado_hc["movilidad_2_11"].'">
										<input type="text" class="input-sm" style="width: 45px" onkeypress="return isNumber(event)" name="movilidad_2_12" value="'.$resultado_hc["movilidad_2_12"].'">
										<input type="text" class="input-sm" style="width: 45px" onkeypress="return isNumber(event)" name="movilidad_2_13" value="'.$resultado_hc["movilidad_2_13"].'">
										<input type="text" class="input-sm" style="width: 45px" onkeypress="return isNumber(event)" name="movilidad_2_14" value="'.$resultado_hc["movilidad_2_14"].'">
										<input type="text" class="input-sm" style="width: 45px" onkeypress="return isNumber(event)" name="movilidad_2_15" value="'.$resultado_hc["movilidad_2_15"].'">
										<input type="text" class="input-sm" style="width: 45px" onkeypress="return isNumber(event)" name="movilidad_2_16" value="'.$resultado_hc["movilidad_2_16"].'">
...
<input type="hidden" name="isb_pd85" id="isb_pd85">
					...
					<div class="container margenSubTitulo">
						...
						<div class="row ">
							...
							<div class="col-5" > <h2>7 INDICADORES DE SALUD BUCAL</h2> </div>
						...
						<div class="row">
							...
							<div class="col-md-6 centrado"> <h4> <strong> HIGIENE ORAL SIMPLIFICADA</strong></h4>

								<div class="row">

									<div class="col-md-6 centrado"> <h4>PIEZAS DENTALES</h4>
									</div>
						...
						<div class="row">
							...
							<div class="col-md-3">
								...
								<div class="row">
									...
									<div class="col-md-2 cent-texto" style="height: 30px;">16</div>
									...
									<div class="col-md-2 cent-texto">17</div>
									...
									<div class="col-md-2 cent-texto">55</div>
								...
								<div class="row">
									<div class="col-md-2 cent-texto" style="height: 30px; ">11</div>
									...
									<div class="col-md-2 cent-texto">21</div>
									...
									<div class="col-md-2 cent-texto">51</div>
								...
								<div class="row">
									<div class="col-md-2 cent-texto" style="height: 30px;  ">26</div>
									...
									<div class="col-md-2 cent-texto">27</div>
									...
									<div class="col-md-2 cent-texto">65</div>
								...
								<div class="row">
									<div class="col-md-2 cent-texto" style="height: 30px;  ">36</div>
									...
									<div class="col-md-2 cent-texto">37</div>
									...
									<div class="col-md-2 cent-texto">75</div>
								...
								<div class="row">
									<div class="col-md-2 cent-texto" style="height: 30px;  ">31</div>
									...
									<div class="col-md-2 cent-texto">41</div>
									...
									<div class="col-md-2 cent-texto">71</div>
								...
								<div class="row">
									<div class="col-md-2 cent-texto" style="height: 30px;">46</div>
									...
									<div class="col-md-2 cent-texto">47</div>
									...
									<div class="col-md-2 cent-texto">85</div>
							...
							<div class="col-md-2">
								...
								<div class="row">
									...
									<div class="col-md-9 cent-texto" style="height: 60px">LEVE</div>
								...
								<div class="row">
									...
									<div class="col-md-9 cent-texto" style="height: 60px">MODERADA</div>
									<div class="col-md-3 cent-texto">
								...
								<div class="row">
									...
									<div class="col-md-9 cent-texto" style="height: 60px">SEVERA</div>
									<div class="col-md-3 cent-texto">
							...
							<div class="col-md-2">
								...
								<div class="row">
									...
									<div class="col-md-9 cent-texto" style="height: 60px">ANGLE I</div>
									<div class="col-md-3 cent-texto">
								...
								<div class="row">
									...
									<div class="col-md-9 cent-texto" style="height: 60px">ANGLE II</div>
									<div class="col-md-3 cent-texto">
								...
								<div class="row">
									...
									<div class="col-md-9 cent-texto" style="height: 60px">ANGLE III</div>
									<div class="col-md-3 cent-texto">
	...
	';
		...
		echo'
							...
							<div class="col-3" style="height: 50px; text-align: right;"> <h4>TOTALES</h4></div>
							<div class="col-1 cent-texto"> <input class="input-sm totalbg" type="text" style="width: 80%;" readonly id="placa-total" name="placa_total" value="'.$placaTOTAL.'"> </div>
							<div class="col-1 cent-texto"> <input class="input-sm totalbg" type="text" style="width: 80%;" readonly id="calculo-total" name="calculo-total" value="'.$calculoTOTAL.'"> </div>
							<div class="col-1 cent-texto"> <input class="input-sm totalbg" type="text" style="width: 80%;" readonly id="gingivitis-total" name="gingivitis-total" value="'.$gingivitisTOTAL.'"> </div>
	...
	<!-- 8 ÍNDICES CPO - ceo -->
					<div class="container margenSubTitulo">
						...
						<div class="row ">
							...
							<div class="col-5" > <h2>8 ÍNDICES CPO - ceo</h2> </div>
...
';
	...
	public function ActualizarHistoriaClinicaC(){
		...
		if($resultado == true){
			...
			echo '<script>
			window.location = "http://localhost/clinica/hc-paciente";
			</script>';
